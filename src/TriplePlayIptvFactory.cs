	...
	public class TriplePlayIptvFactory : EssentialsPluginDeviceFactory<TriplePlayIptvDevice>
	{
		...
		public override EssentialsDevice BuildDevice(DeviceConfig dc)
		{
			try
			{
			    ...
			    {
			        Debug.LogInformation( "[{0}] Unable to get configuration. Please check configuration.", dc.Key);
			        return null;
			    }
			    ...
			    switch (propertiesConfig.Control.Method)
			    {
			        ...
			        case eControlMethod.Https:
			            ...
			            break;
			        default:
			            Debug.LogInformation( "[{0}] Control method {1} NOT supported. Please check configuration", dc.Key,
